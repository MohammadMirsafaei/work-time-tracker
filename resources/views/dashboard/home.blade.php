...
<a class="border rounded d-inline scroll-to-top" href="#page-top"><i class="fas fa-angle-up"></i></a><button class="btn btn-success btn-lg border rounded-circle" data-toggle="modal" data-target="#addTimeModal" type="button"><i class="fa fa-plus"></i></button>
        <div class="modal fade tada animated" role="dialog" tabindex="-1" id="addTimeModal">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Add Time</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group"><input class="form-control" type="date" name="date"></div>
                        <div class="form-group"><input class="form-control" type="time" name="start"></div>
                        <div class="form-group"><input class="form-control" type="time" name="end"></div>
                        ...
                        <div class="form-group"><select class="form-control" name="project">

                            </select></div>
                    </div>
                    <div class="modal-footer"><button class="btn btn-light" type="button" data-dismiss="modal">Close</button><button class="btn btn-primary" id="saveBtn" type="button">Add</button></div>
                </div>
            </div>
        </div>
@endsection
